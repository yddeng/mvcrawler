...
func TestNewDownLoader(t *testing.T) {
	...
	_ = d.Push(&mvcrawler.DownloadReq{Url: "http://www.bimibimi.tv", Name: "www.bimibimi.tv.html"})
	_ = d.Push(&mvcrawler.DownloadReq{Url: "http://www.halihali.in", Name: "www.halihali.in.html"})
	_ = d.Push(&mvcrawler.DownloadReq{Url: "http://www.dililitv.com", Name: "www.dililitv.com.html"})
